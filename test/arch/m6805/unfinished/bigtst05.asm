       ...
       NAM BIGTST05
       TTL **** 6805 TOTAL INSTRUCTION TEST ****
*       OPT LLEN=80
*
******************************************************
******************************************************
...
*        Corrections marked '*' to the right: A.Riiber
*
*****************************************************
*****************************************************
*
...
*
       ORG $100
TMP2   RMB 2		* Goes into 6805 rom
       PAGE
       TTL **** 6805 TOTAL INSTRUCTION TEST - GROUP 3 ****
*
*****************************************************
*
*      G R P 3
...
*T19	BGT	*
	BRA	GRP1	GO DO GROUP 1
       ...
       PAGE
       TTL **** 6805 TOTAL INSTRUCTION TEST - GROUP 1 ****
*
******************************************************
*
*      G R P 1
...
*
*
GRP1	LDA	DATA     DATA=@252,N=1,Z=0,V=0
A1      BPL	A1
A2      BEQ    	A2
*A3     BVS    	A3
        EOR    	DATA
A4      BNE    	A4
        LDA    	DATA+1   DATA+1=@125,N=0,Z=0,V=0
A5      BMI    	A5
        EOR    	DATA+1
A6      BNE    	A6
        LDA    	DATA+3   DATA+3=@0,N=0,Z=1,V=0
A7      BNE    	A7
********************************************
*
...
*
	LDA 	DATA	 DATA+1=@252,DATA+1=@125,N=0
	AND 	DATA+1
	BMI	*
	BNE	*
*A62	BVS	A62
	LDA 	DATA+1
	AND 	DATA	 N=0,Z=1,V=0
A63	BMI	A63
	BNE	*
*A65	BVS	A65
	LDA 	DATA+5	 DATA+5=@377,N=1,Z=0,V=0
	AND 	DATA+5
A66	BPL	A66
A67	BEQ	A67
	EOR 	DATA+5	 Z=1
...
*
	LDA	DATA	 DATA=@252
	ORA	DATA+1	 DATA+1=@125,N=1,Z=0,V=0
A801	BPL	A801
A802	BEQ	A802
*A803	BVS	A803
	EOR	DATA+5	 DATA+5=@377
A804	BNE	A804
	LDA	DATA+1
	ORA	DATA
A805	BPL	A805
...
*
	LDA	DATA+1	 DATA+1=@125
	ADD	DATA+1	 N=1,Z=0,V=1,C=0
A100	BPL	A100
A101	BEQ	A101
*A102	BVC	A102
A103	BCS	A103
...
A104	BNE	A104
	LDA	DATA
	ADD	DATA	 N=0,Z=0,V=1,C=1
A105	BMI	A105
A106	BEQ	A106
*	BVC	*
A108	BCC	A108
	EOR	DATA+7	 DATA+7=@124
A109	BNE	A109
	LDA	DATA+9	 DATA+9=@201(-127)
	ADD	DATA+10	  DATA+10=@277(-65),N=0,Z=0
A110	BMI	A110
A111	BEQ	A111
*A112	BVC	A112
A113	BCC	A113
	EOR	DATA+6	 DATA+6=@100
A114	BNE	A114
	LDA	DATA+9	 DATA+9=@201
	ADD	DATA+5	 DATA+5=@377,N=1,Z=0,V=0,C=1
A115	BPL	A115
A116	BEQ	A116
*A117	BVS	A117
A118	BCC	A118
	EOR	DATA+8	 DATA+8=@200
A119	BNE	A119
	LDA	DATA+5	 DATA+5=@377
	ADD	DATA+3	 DATA+3=0,N=1,Z=0,V=0,C=0
A120	BPL	A120
A121	BEQ	A121
*A122	BVS	A122
A123	BCS	A123
...
A124	BNE	A124
	LDA	DATA+5	 DATA+5=@377
	ADD	DATA+5	 N=1,Z=0,V=0,C=1
A125	BPL	A125
A126	BEQ	A126
*A127	BVS	A127
A128	BCC	A128
	EOR	DATA+11	  DATA+11=@376
A129	BNE	A129
	LDA	DATA+3	 DATA+3=0
	ADD	DATA+3	 N=0,Z=1,V=0,C=0
A130	BMI	A130
A131	BNE	A131
*A132	BVS	A132
A133	BCS	A133
...
*                           UP NEXT TEST,N=1.Z=0,V=0,C= *
             SBCB   DATA+14   DATA+14=@177;ACCUM b=@177,*
*                           N=0,Z=0,V=1,C=0		*
             BMI    *        N=1?			*
             BEQ    *        NO,Z=1?			*
             BVC    *        NO,V=0?			*
...
*                           N=0,Z=0,V=0,C=0
*            CMPB   DATA+14   ACCUM 
             CMPB   DATA+14   ACCUM b=@177,N=0,Z=1,V=0,C*
             BMI    *        N=1?			*
             BNE    *        NO,Z=0?			*
             BCS    *        NO,C=1?			*
             EORB   DATA+14   NO,SEY UP EXEC TEST	*
             BNE    *        WAS ACCUM b STILL=@177?	*
*                           YES.N=0,Z=1,V=0,C"=1,ACCUM	*
...
*            LDAB  DATA+5   DATA+5=@377,SET E    *        NO,Z=0?
             LDAB   DATA+5   DATA+5=@377,SET UP TEST	*
             SEV             SET OVERFLOW		*
             BVC    *        VERIFY OVERFLOW SET	*
             SEC             SET CARRY			*
             BCC    *        VERIFY CARRY SET		*
...
*      * * * * * * * * * * * * * * * * * * * * * * * * * * *
       ...
       BRA GRP6
       PAGE
       TTL **** 6805 TOTAL INSTRUCTION TEST - GROUP 6 ****
*
*********************************************************
*
*      G R P 6
...
*
       ...
       BRA GRP2
       PAGE
       TTL **** 6805 TOTAL INSTRUCTION TEST - GROUP 2 ****
*
************************************************************
*
*      G R P 2
...
OC377  FCB @377
       PAGE
       TTL **** 6805 TOTAL INSTRUCTION TEST - GROUP 4 ****
*
*
*****************************************************
*
...
*
       ...
       BRA GRP5
       PAGE
       TTL **** 6805 TOTAL INSTRUCTION TEST - GROUP 5 ****
*
***********************************************
*
*      G R P 5
