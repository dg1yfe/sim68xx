...
struct opcode opcodetab[256] = {
	...
	{0xD4, 1, 1, andb_dir,	3,	"andb  %02x"},
	{0xD5, 1, 1, bitb_dir,	3,	"bitb  %02x"},
	...
	{0xE4, 1, 1, andb_ind_x,	4, "andb  %02x,x"},
	{0xE5, 1, 1, bitb_ind_x,	4, "bitb  %02x,x"},
	...
	{0xF4, 1, 2, andb_ext,	4,	"andb  %04x"},
	{0xF5, 1, 2, bitb_ext,	4,	"bitb  %04x"},
...
struct opcode opcodetab2[256] = {
	...
	{0xE4, 2, 1, andb_ind_y,	5, "andb  %02x,y"},
	{0xE5, 2, 1, bitb_ind_y,	5, "bitb  %02x,y"},
