...
/* All rights reserved.                 */
/* >>>                                  */
/* 6800map.c - opcode map 6800 cpu core */

#include "optab.h"		/* struct opcodetab */
#include "opfunc.h"

/*
 * Opcode map 1 - the only one for 6800
 */
struct opcode opcodetab[256] = {
	...
	{0xD3, 1, trap,		4,	"---"},
	{0xD4, 1, andb_dir,	3,	"andb %02x"},
	{0xD5, 1, bitb_dir,	3,	"bitb %02x"},
	...
	{0xE3, 1, trap,		5,	"---"},
	{0xE4, 1, andb_ind_x,	4,	"andb %02x,x"},
	{0xE5, 1, bitb_ind_x,	4,	"bitb %02x,x"},
	...
	{0xF3, 2, trap,		5,	"---"},
	{0xF4, 2, andb_ext,	4,	"andb %04x"},
	{0xF5, 2, bitb_ext,	4,	"bitb %04x"},
